  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto mb-12">
        <h1 className="text-5xl font-bold mb-6 text-deep-indigo">{dict.help.title}</h1>
        ...
        <div className="mb-12">
            ...
            <div className="flex">
              ...
              <div className="ml-6">
                <h3 className="text-lg font-semibold text-deep-indigo mb-2">
                  {dict.help.personalized.title}
                </h3>
                <p className="text-muted-foreground leading-relaxed">
                  {dict.help.personalized.description}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-deep-indigo">{dict.help.howToHelp.title}</h3>
              <ul className="space-y-3 text-muted-foreground">
                {dict.help.howToHelp.items.map((item, index) => (
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-deep-indigo">{dict.help.confidentiality.title}</h3>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                {dict.help.confidentiality.p1}
              </p>
              <p className="text-muted-foreground leading-relaxed">
                {dict.help.confidentiality.p2}
              </p>
            </div>
          </div>
        </div>
      ...
      <Only when={!helpEnabled}>
        <div className="text-center py-20 bg-gradient-to-br from-emerald-green/5 to-celestial-blue/5 rounded-3xl">
          ...
          <h3 className="text-xl font-semibold text-deep-indigo mb-2">{dict.help.unavailable.title}</h3>
