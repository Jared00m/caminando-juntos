  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="py-20">
        <h2 className="text-4xl font-bold text-center mb-4 text-deep-indigo">{dict.home.features.title}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-deep-indigo">{dict.home.features.studies.title}</h3>
            <p className="text-muted-foreground leading-relaxed">
              {dict.home.features.studies.description}
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-deep-indigo">{dict.home.features.videos.title}</h3>
            <p className="text-muted-foreground leading-relaxed">
              {dict.home.features.videos.description}
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-deep-indigo">{dict.home.features.community.title}</h3>
            <p className="text-muted-foreground leading-relaxed">
              {dict.home.features.community.description}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-celestial-blue/10 via-white to-sunrise-gold/10 rounded-3xl shadow-lg">
        <div className="text-center px-8">
          <h2 className="text-4xl font-bold mb-6 text-deep-indigo">{dict.home.region.title}</h2>
          <p className="text-muted-foreground mb-10 max-w-2xl mx-auto text-lg leading-relaxed">
            {dict.home.region.description}
          </p>
          <CountrySwitcher />
        </div>
      </section>
